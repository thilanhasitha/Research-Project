...
Write-Host "1️⃣  Checking backend container..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "3️⃣  Testing backend API..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "4️⃣  Running internal diagnostics..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "5️⃣  Checking MongoDB connection..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "6️⃣  Checking Ollama connection..." -ForegroundColor Yellow
...
if ($ollamaStatus -like "*Up*") {
    ...
    if ($models -match "llama3") {
        ...
        Write-Host "   ⚠️  Ollama model may not be pulled" -ForegroundColor Yellow
...
if (-not $hasError) {
    ...
    Write-Host "⚠️  Issues detected. Common fixes:" -ForegroundColor Yellow
    Write-Host ""
