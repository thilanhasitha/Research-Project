...
Write-Host ""
Write-Host "5  Checking Ollama model..." -ForegroundColor Yellow
$modelName = "llama3.2"
...
try {
    ...
    Write-Host "     Could not check Ollama model: $($_.Exception.Message)" -ForegroundColor Yellow
...
# Step 7: Run test
Write-Host ""
Write-Host "7  Running system test..." -ForegroundColor Yellow
